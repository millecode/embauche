...
<main>
    <div class="container mt-5">
        <h1 class="mb-4 text-center"><?= $lang[$current_lang]['Liste des emplois'] ?></h1>
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <form method="GET" class="row g-3 mb-4">
                    <div class="col-md-6">
                        <input type="text" name="title" class="form-control" placeholder="<?= $lang[$current_lang]['Rechercher par titre'] ?>..."
                ...
                <div class="row">
                    ...
                    <?php else: ?>
                        <div class="col-12">
                            <p class="text-center"><?= $lang[$current_lang]['Aucune offre d\'emploi trouvée'] ?>.</p>
                        </div>
                    <?php endif; ?>
                </div>
