...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($password)) {
        $error = $lang[$current_lang]["Il y'a des champs vides"] . ".";
    } elseif ($password !== $confirm_password) {
        $error = $lang[$current_lang]["Le mot de passe et sont confirmation n'est sont pas egaux"] . ".";
    } elseif ($user) {
        $error = $lang[$current_lang]["L'utilisateur est déjà inscrit"] . ".";
    } else {
        ...
        try {
            ...
            $success = $lang[$current_lang]["Inscription bien reussi. Veuillez confirmer votre email"] . '.';
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                    <div class="text-center">
                        <h1><?= $lang[$current_lang]['Inscription'] ?></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-6">
                <div class="col-xl-5 col-lg-6 col-md-8 col-12">
                    ...
                    <div class="card shadow-sm mb-3">
                        <div class="card-body">
                            <form class="needs-validation mb-6" method="post" action="register.php">
                                <div class="mb-3">
                                    <label for="nom" class="form-label"><?= $lang[$current_lang]['Votre nom'] ?> :</label>
                                ...
                                <div class="mb-3">
                                    <label for="role"><?= $lang[$current_lang]['Choisissez votre role'] ?> :</label>
                                ...
                                <div class="mb-3">
                                    <label for="confirme" class="form-label"><?= $lang[$current_lang]['Confirmer le mot de passe'] ?> :</label>
                                    <div class="password-field position-relative">
                                ...
                                <div class="d-grid">
                                    <button class="btn btn-warning" type="submit" name="submit"><?= $lang[$current_lang]["S'inscrire"] ?></button>
                                </div>
                            </form>
                    ...
                    <span>
                        <?= $lang[$current_lang]["Vous avez un compte"] ?> ?
                        <a href="login.php" class="text-primary"><?= $lang[$current_lang]["Se connecter"] ?>.</a>
                    </span>
                </div>
            </div>
