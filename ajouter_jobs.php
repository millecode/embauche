            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                    <div class="text-center">
                        <?php if ($edit_mode): ?>
                            <h1><?= $lang[$current_lang]['Modifier un job'] ?></h1>

                        <?php else : ?>
                            <h1><?= $lang[$current_lang]['Ajouter un job'] ?></h1>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm mb-3">
                    <div class="card-body">
                        <form class="needs-validation mb-6" method="post">
                            <div class="mb-3">
                                <label for="title" class="form-label"><?= $lang[$current_lang]['Titre du Job'] ?></label>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="mb-3">
                                        <label class="form-label"><?= $lang[$current_lang]['Choisisez une categorie'] ?></label>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="mb-3">
                                        <label for="location" class="form-label"><?= $lang[$current_lang]['Localisation'] ?></label>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="mb-3">
                                        <label class="form-label"><?= $lang[$current_lang]['Type des jobs'] ?></label>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="salary" class="form-label"><?= $lang[$current_lang]['Salaire'] ?></label>
                                        <input type="number" class="form-control" id="salary" name="salary" value="<?= htmlspecialchars($salary); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="description" class="form-label"><?= $lang[$current_lang]['Description'] ?></label>
                            ...
                            <button type="submit" class="btn btn-primary"><?= $lang[$current_lang]['Enregistrer le Job'] ?></button>
                        </form>
