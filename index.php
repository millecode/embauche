      ...
      <div class="row align-items-center gy-6">
        <div class="col-lg-5 col-xl-5" data-cue="zoomOut">
          <div class="d-flex flex-column gap-4">
            ...
            <div>
              <h2 class="display-6 mb-3"><?= $lang[$current_lang]["La plateforme n°1 d'embauche à Djibouti"] ?>.</h2>
              <p class="lead"><?= $lang[$current_lang]["Découvrez les meilleures opportunités et construisez votre avenir dès maintenant"] ?>.</p>
              <ul class="list-unstyled d-flex flex-column gap-2">
                <li class="d-flex flex-row gap-2">
                  ...
                  <span><?= $lang[$current_lang]["Partager vos offres d'emplois"] ?></span>
                </li>
                <li class="d-flex flex-row gap-2">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle text-success" viewbox="0 0 16 16">
                  ...
                  <span><?= $lang[$current_lang]["Trouver les meilleurs candidat"] ?></span>
                </li>
                <li class="d-flex flex-row gap-2">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle text-success" viewbox="0 0 16 16">
                  ...
                  <span><?= $lang[$current_lang]["La garantie est au rendez-vous"] ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="d-flex flex-row gap-3 align-items-center">
              <?php if ($user_role === 'guest' || $user_role === 'recruiter'): ?>
                <a href="ajouter_jobs.php" class="btn btn-warning mb-3">
                  <?= $lang[$current_lang]["Partager une offre d'emploi"] ?>
                </a>
              <?php endif; ?>
              ...
              <span>
                ...
                <?php if ($user_role === 'guest' || $user_role === 'candidate'): ?>
                  <a href="categories.php">
                    <?= $lang[$current_lang]["Trouver un emploi"] ?>
                  </a>
                <?php endif; ?>
              </span>
            </div>
  ...
  <div class="container">
    <div class="row my-5">
      <div class="col-md-8 col-12">
        <h3 class="text-center"> <?= $lang[$current_lang]["Liste des dernieres offres disponibles"] ?></h3>
        <div class="mt-3">
          ...
          <form method="GET" class="row g-3 mb-4">
            ...
            <div class="col-md-4">
              <select name="category_id" class="form-select">
                <option value=""><?= $lang[$current_lang]["Toutes les catégories"] ?></option>
            ...
            <div class="col-md-2">
              <button type="submit" class="btn btn-primary"><?= $lang[$current_lang]["Rechercher"] ?></button>
            </div>
          </form>
        </div>
        ...
        <div class="row">
          <!-- Liste des jobs -->
          <?php if (empty($jobs)): ?>
            <div class="alert alert-info my-2"><?= $lang[$current_lang]["Aucune offre d'emploi trouvée"] ?>.</div>
          <?php else: ?>
          ...
          <div class="mt-5">
            ...
            <?php if (!empty($categories)): ?>
              <div class="list-group">
                <h5 class="mb-3 text-center"><?= $lang[$current_lang]["Liste des Catégories disponible"] ?></h5>
                <?php foreach ($categories as $category): ?>
            ...
            <?php else: ?>
              ...
              <div class="alert alert-danger"><?= $lang[$current_lang]["Aucune catégorie trouvée"] ?>.</div>
